...
export interface ApproachStep { number: string; title: string; description: string }
...
export const siteConfig = {
  ...
  contact: {
    ...
    phoneSecondary: '',
    email: 'info@proximsoftsol.com',
    address: {
      streetAddress: '254 Chapman Rd, Ste 208 #18400',
      addressLocality: 'Newark',
      addressRegion: 'DE',
      postalCode: '19702',
      addressCountry: 'US',
    },
    addressDisplay: '254 Chapman Rd, Ste 208 #18400, Newark, DE 19702',
    directionsNote: 'Open Mon–Fri 9:00–18:00',
    mapsUrl: 'https://maps.google.com/?q=254+Chapman+Rd+Ste+208,+Newark+DE+19702',
  ...
  // ─── Meta tags ───────────────────────────────────────────────────────────────
  meta: {
    title: 'Proximsoft Solutions LLC — Enterprise IT Consulting | SAP · Salesforce · AI',
    description: 'Proximsoft Solutions LLC delivers end-to-end enterprise IT consulting across SAP, Salesforce, Oracle, Microsoft, and AI-powered platforms. From strategy to go-live — done right.',
    canonicalUrl: 'https://www.proximsoftsol.com',
  },
  ...
  hero: {
    ...
    subheadline: 'Proximsoft Solutions LLC helps enterprises unlock value through SAP, Salesforce, Oracle, Microsoft, and AI-powered platforms — from strategy to go-live.',
    ...
    slides: [
      {
        ...
        description: 'Proximsoft Solutions LLC helps enterprises unlock value through SAP, Salesforce, Oracle, Microsoft, and AI-powered platforms — from strategy to go-live.',
      ...
      },
      {
        ...
        description: '20+ years of enterprise implementation experience. We modernise, integrate, and optimise the technology that runs your business.',
        cta: { text: 'Schedule a Call', href: '#contact-form' },
        image: '/images/slider/h11.jpg',
  ...
  // ─── Trust signals / About ────────────────────────────────────────────────
  trust: {
    subTitle: 'Welcome to Proximsoft Solutions LLC',
    headline: 'Enterprise Technology, Delivered With Precision',
    description: 'Proximsoft Solutions LLC is a US-based IT consulting firm helping enterprises modernize, scale, and compete in a rapidly changing landscape. From SAP and Salesforce to Oracle, Microsoft, and custom-built platforms, we combine deep technical expertise with proven delivery frameworks to turn complex technology programs into measurable business outcomes.',
    image: '/images/about/about11.png',
    imageAlt: 'Proximsoft Solutions LLC consulting team at work',
    stats: [
      { value: 20, suffix: '+', label: 'Years of Experience' },
      { value: 8, suffix: '', label: 'Service Lines' },
    ],
    statDescriptions: [
      'Over two decades of delivering enterprise-grade IT solutions across SAP, Salesforce, Oracle, Microsoft, and custom-built platforms for clients across the US and beyond.',
  ...
  aboutDark: {
    subTitle: 'About Proximsoft Solutions LLC',
    ...
    imageAlt: 'Proximsoft Solutions LLC company overview',
  ...
  approach: {
    ...
    headline: 'Our Engagement Approach',
    description: 'Every Proximsoft Solutions LLC engagement follows the same four-phase model — so you always know what happens next.',
    steps: [
      {
        number: '01',
        title: 'Discovery',
        description: 'We start with a deep-dive into your business processes, current technology landscape, and strategic goals — so our recommendations are grounded in reality, not templates.',
      },
      {
        number: '02',
        title: 'Planning',
        description: 'Together we define scope, milestones, and success metrics. You get a realistic delivery plan with clear accountability at every stage.',
      },
      {
        number: '03',
        title: 'Delivery',
        description: 'Senior-certified consultants lead hands-on implementation, keeping you informed at every sprint with transparent progress updates.',
      },
      {
        number: '04',
        title: 'Support',
        description: 'We stay accountable long after go-live — providing AMS, enhancements, and health checks so your investment keeps delivering.',
      },
    ] as ApproachStep[],
  },
    ...
    items: [
      {
        ...
        description: 'Every engagement is staffed with certified, senior consultants — never juniors learning on your project.',
      },
      {
        icon: 'dollar',
        title: 'Transparent Pricing',
        description: 'No surprise invoices. Our costs run 30–40% below big-firm benchmarks, with clear scope and fixed-price options available.',
      },
      {
        icon: 'shield',
        title: 'Lasting Accountability',
        description: 'We own delivery from day one through go-live — and stay engaged with AMS and support long after launch.',
      },
    ] as ValueItem[],
  },
  ...
  testimonials: {
    ...
    description: 'We measure success by the outcomes our clients achieve. Here is what enterprise leaders across manufacturing, healthcare, financial services, and logistics have to say about working with Proximsoft Solutions LLC.',
    quoteIcon: '',
    items: [
      {
        name: 'James Hoffman',
        text: 'Proximsoft Solutions LLC handled our SAP S/4HANA migration from start to finish. Their team understood our business processes deeply and delivered on time without disruption to day-to-day operations. I would not hesitate to work with them again.',
        role: 'VP of IT, Global Manufacturing Co.',
        avatar: '/images/testimonial/avatar/1.jpg',
      },
      {
        name: 'Sarah Chen',
        text: 'The Salesforce and SAP integration Proximsoft Solutions LLC built for us eliminated weeks of manual data reconciliation. Their solution was elegant, well-documented, and the support after go-live has been outstanding.',
        role: 'CTO, Regional Healthcare Network',
        avatar: '/images/testimonial/avatar/2.jpg',
      },
      {
        name: 'David Park',
        text: 'We brought Proximsoft Solutions LLC in to rescue a stalled ERP project. Within four weeks they had a clear plan, rebuilt stakeholder confidence, and delivered a fully working system three months later. Exceptional recovery.',
        role: 'Director of Operations, Retail Group',
        avatar: '/images/testimonial/avatar/3.jpg',
      },
      {
        name: 'Lisa Thompson',
        text: "Proximsoft Solutions LLC's data and AI team built us a real-time reporting dashboard that our executives actually use. The insights we now have were simply not possible before. It has genuinely changed how we make decisions.",
  ...
  faq: [
    {
      question: 'What enterprise platforms does Proximsoft Solutions LLC specialise in?',
    ...
    {
      question: 'How do I get started with Proximsoft Solutions LLC?',
  ...
  contactForm: {
    ...
    sideImageAlt: 'Proximsoft Solutions LLC consulting team',
  },

  // ─── Careers ─────────────────────────────────────────────────────────────
  careers: {
    meta: {
      title: 'Careers | Proximsoft Solutions LLC',
      description: 'Join Proximsoft Solutions LLC and help shape the future of enterprise technology. Explore open roles in SAP, Salesforce, Data & AI, and project management.',
    },
    whyWorkWithUs: [
